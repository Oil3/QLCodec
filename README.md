...
## Install  
>Optionally move to `/Applications`, then launch the app. This registers the extension as the extension itself stays within the app bundle.  
...
##
Download version 1.0 from [Releases ](https://github.com/Oil3/QLCodec/releases/tag/qlc-1.0-universalBinary) or [direct-download](https://github.com/Oil3/QLCodec/releases/download/qlc-1.0-universalBinary/QLCodec.-.1.0.Universal.Binary.zip).  
